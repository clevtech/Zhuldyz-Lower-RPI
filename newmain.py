...
def process_frame(frame):
    lower_bound_color = np.array([0, 0, 120])
    upper_bound_color = np.array([150, 150, 255])
    lower_bound_floor = np.array([0,0,0])
    upper_bound_floor = np.array([255,255,120])
    gamma_frame = gamma_correction(frame, 2)
    ...
    lines = cv2.HoughLines(edges_frame,1,np.pi/180,30)
